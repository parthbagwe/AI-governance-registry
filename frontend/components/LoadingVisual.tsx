...
/**
 * Picks one of two market visuals at random.
 *
 * Two rather than one because a loading screen is seen dozens of times in a
...
export type VisualVariant = "candles" | "ticker";

const VARIANTS: VisualVariant[] = ["candles", "ticker"];
